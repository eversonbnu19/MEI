...
function openApp(){
  ...
  appOpenPromise=(async()=>{
    window.__GESTAO_SB__=sb;
    const response=await fetch('./app.js?v=31',{cache:'no-store'});
    ...
    showPanelVersion();
    import('./patch-direct-users.js?v=31').catch(console.error);
    import('./patch-company-dashboard.js?v=31').catch(console.error);
    import('./patch-contract-cancel.js?v=31').catch(console.error);
    import('./patch-audit-payment.js?v=31').catch(console.error);
    import('./patch-entry-adjustments.js?v=31').catch(console.error);
    import('./patch-preclose-review.js?v=31').catch(console.error);
    import('./patch-notifications.js?v=31').catch(console.error);
    import('./patch-logout-return.js?v=31').catch(console.error);
  })();
