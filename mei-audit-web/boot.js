...
function openApp(){
  ...
  appOpenPromise=(async()=>{
    window.__GESTAO_SB__=sb;
    const response=await fetch('./app.js?v=24',{cache:'no-store'});
    ...
    showPanelVersion();
    import('./patch-direct-users.js?v=24').catch(console.error);
    import('./patch-company-dashboard.js?v=24').catch(console.error);
    import('./patch-contract-cancel.js?v=24').catch(console.error);
    import('./patch-audit-payment.js?v=24').catch(console.error);
  })();
