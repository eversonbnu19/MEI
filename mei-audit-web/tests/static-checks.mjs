...
assert.match(index,/Gestão de Contratos v29/,'index deve identificar visualmente a versao v29');
assert.match(index,/boot\.js\?v=29/,'index deve carregar boot v29');
assert.match(boot,/const APP_VERSION='v29'/,'boot deve declarar v29');
...
assert.match(boot,/app\.js\?v=29/,'boot deve carregar app v29');
assert.match(boot,/patch-preclose-review\.js\?v=29/,'boot deve carregar pre-conferencia v29');
assert.match(boot,/patch-logout-return\.js\?v=29/,'boot deve carregar hotfix de logout v29');
...
assert.match(sw,/gestao-contratos-v29/,'service worker deve usar cache v29');
...
console.log('OK - v29 com GPS obrigatório validada.');
